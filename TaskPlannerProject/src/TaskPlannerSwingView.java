...
public class TaskPlannerSwingView implements Observer{
    ...
    LocalDate birthday  = LocalDate.of(2003, 1, 16);
    ...
    public void createAndShowGUI() {
        ...
        for (Task task : tasks) {
            tableModel.addRow(new Object[]{task.getName(), task.getDescription(), task.getCategory(), task.getDeadline()});
        }
        ...
        ImageIcon updateIcon = new ImageIcon("src\\update.png");
    ...
    private void openTaskDialog(JFrame parentFrame, String title, String[] taskDetails, DefaultTableModel tableModel, int rowIndex) {
        ...
        deadlineField.setBounds(150, 150, 200, 25);
